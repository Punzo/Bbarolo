...
public:
    ...
    void extractMaskSpectrum(bool *MaskArray, int *dim, long pixel);   /// Extract a spectrum from a mask array.
    void extractMaskImage(bool *MaskArray, int *dim, long channel);	   /// Extract an image from a mask array.
    void extractMaskSpectrum(Cube<Type> &cube, long pixel);            /// Extract a spectrum from a mask cube.
    void extractMaskImage(Cube<Type> &cube, long channel);             /// Extract an image from a mask cube.
...
protected:
    ...
    bool        *mask;                      ///< The mask cube data array.
    bool        maskAllocated;              ///< Is mask allocated?
